    ...
    <nav className="sticky top-0 left-0 right-0 z-50 bg-background/95 backdrop-blur-lg border-b border-border shadow-soft">
      <div className="container mx-auto px-4 py-3 flex items-center justify-between gap-4">
        ...
        <div className="flex items-center gap-2">
           <Link to="/home-product-modify" className="p-2 rounded-full hover:bg-gray-200 dark:hover:bg-gray-700 transition ">
...
export default NavbarEditProduct;
